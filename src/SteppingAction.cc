...
//       if (energy_MeV[i] == 0.51099891) 
//        energy_MeV[i] = 0;
//         G4cout << std::setprecision(10) << "energy_MeV[i]: " << energy_MeV[i] << ", TotalEnergyDeposit(): "<<aStep->GetTotalEnergyDeposit() << ", Detector: " << detectorName[i] <<G4endl;
    }
  }
}
