...
// EXPERIMENTAL ROOM
  ...
  G4LogicalVolume* room_log = new G4LogicalVolume(room_tube,N78O21Ar1,"room",0,0,0); // room is filled with vacuum, not air
...
// BEAM PIPE
  ...
  G4double innerR_beam = outerR_beam -0.000*mm - 0.889*mm;      //edit this to change the thickness of the beam pipe
